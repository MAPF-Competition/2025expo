...
<div style="display: flex; justify-content: center;">
    ...
    <div style="width: 65%;margin-left:10px">
        ...
        <br/>
        <small style="font-size: 18.75px; color: #c0c0c0;">Senior Applied Scientist at Amazon Robotics</small>
        </h3>
        <br/>
    </div>
</div>
...
<div style="display: flex; justify-content: center;">
    ...
    <div style="width: 65%;margin-left:10px">
        <h3>Amanda Prorok
        <br/>
        <small style="font-size: 18.75px; color: #c0c0c0;">Professor, Department of Computer Science and Technology, Cambridge University</small>
        </h3>
        <br/>
    </div>
</div>
